<div class="content-main">
    ...
    <?php $productcatv = $cache->get("select * from #_product_cat where type = ? and id_list = ? and find_in_set('hienthi',status) order by numb,id desc", array('san-pham', $idl), 'result', 7200);
