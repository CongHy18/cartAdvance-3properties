    ...
    <form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-xl-4">
                ...
                <?php if (isset($config['product'][$type]['images_cat2']) && $config['product'][$type]['images_cat2'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        <div class="card-header">
                            <h3 class="card-title">Banner <?= $config['product'][$type]['title_main_cat'] ?></h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            $photo2Detail['dimension'] = "Width: " . $config['product'][$type]['width_cat2'] . " px - Height: " . $config['product'][$type]['height_cat2'] . " px (" . $config['product'][$type]['img_type_cat2'] . ")";
                ...
                <?php if (isset($config['product'][$type]['images_cat3']) && $config['product'][$type]['images_cat3'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        <div class="card-header">
                            <h3 class="card-title">Banner <?= $config['product'][$type]['title_main_cat'] ?></h3>
                            <div class="card-tools">
                        ...
                        <div class="card-body">
                            ...
                            /* Photo detail */
                            $photo3Detail = array();
                            $photo3Detail['upload'] = UPLOAD_PRODUCT_L;
                            $photo3Detail['image'] = (!empty($item)) ? $item['photo3'] : '';
                            $photo3Detail['dimension'] = "Width: " . $config['product'][$type]['width_cat3'] . " px - Height: " . $config['product'][$type]['height_cat3'] . " px (" . $config['product'][$type]['img_type_cat3'] . ")";
