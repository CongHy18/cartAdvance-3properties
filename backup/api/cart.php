...
if ($cmd == 'add-cart' && $id > 0) {
    ...
    $prosaleinfo = $cart->getProSaleInfo($id,$color,$size);
                            ...
                            <div class="form-row">
                                ...
                                <div class="quantity-procart col-3 col-md-2">
                                    ...
                                    <div class="quantity-counter-procart quantity-counter-procart-<?= $code ?>">
                                        ...
                                        <input type="number" class="quantity-procart" min="1" value="<?= $quantity ?>" data-pid="<?= $pid ?>" data-color="<?= $color ?>"  data-size="<?= $size ?>" data-code="<?= $code ?>" />
