...
$rowSaleDetail = $d->rawQueryOne("select sale_price, regular_price, discount, id from #_product_sale where id_parent = ? and id_color = ? and id_size = ? and id_version = ? limit 0,1", array($id_pro, $id_color, $id_size, $id_version));
?>
