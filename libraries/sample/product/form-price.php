<div class="row">
	<div class="col-12">
		<div class="d-block text-success"><label>Giá theo thuộc tính: </label> <span class="text-info">
				(<?= $params['sale']['nameColor'] ?>
				<?= ($params['sale']['nameColor'] && $params['sale']['nameSize']) ? '-' : '' ?>
				<?= $params['sale']['nameSize'] ?>
				<?= ($params['sale']['nameSize'] && $params['sale']['nameVersion']) ? '-' : '' ?>
				<?= $params['sale']['nameVersion'] ?>)</span> </div>
	</div>
