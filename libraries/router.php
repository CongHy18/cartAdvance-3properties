...
$requick = array(
    ...
    // array("tbl" => "product_list", "field" => "idl", "source" => "product", "com" => "combo", "type" => "combo"),
    // array("tbl" => "product_cat", "field" => "idc", "source" => "product", "com" => "combo", "type" => "combo"),
    // array("tbl" => "product_item", "field" => "idi", "source" => "product", "com" => "combo", "type" => "combo"),
    // array("tbl" => "product_brand", "field" => "idb", "source" => "product", "com" => "thuong-hieu", "type" => "combo"),
    // array("tbl" => "product", "field" => "id", "source" => "product", "com" => "combo", "type" => "combo", "menu" => true),

    /* Tags */
    array("tbl" => "tags", "tbltag" => "news", "field" => "id", "source" => "tags", "com" => "tags-tin-tuc", "type" => "tin-tuc", "menu" => true),

    /* Thư viện ảnh */
    array("tbl" => "product", "field" => "id", "source" => "product", "com" => "showroom", "type" => "showroom", "menu" => true),

    array("tbl" => "product", "field" => "id", "source" => "product", "com" => "da-xem", "type" => "da-xem", "menu" => true),
    ...
    array("tbl" => "static", "field" => "id", "source" => "static", "com" => "chi-nhanh", "type" => "chi-nhanh", "menu" => true),

    array("tbl" => "static", "field" => "id", "source" => "static", "com" => "bang-bao-gia", "type" => "bang-bao-gia", "menu" => true),
...
switch ($com) {
    ...
    //     $seo->set('type', isset($_GET['id']) ? "article" : "object");
    //     $type = $com;
    //     $titleMain = "Combo Thiết Bị Vệ Sinh";
    //     break;

    case 'da-xem':
        $source = "product";
        $template = "product/just_seen";
        $seo->set('type', 'object');
        $type = $com;
        $titleMain = "Sản phẩm đã xem";
        break;
