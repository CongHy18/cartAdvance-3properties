...
<section class="content">
    ...
    <div class="card card-primary card-outline text-sm mb-0">
        <div class="card-header">
            ...
            <?php } ?>
            <?php if(isset($config['order']['billall']) && $config['order']['billall'] == true) { ?>
                <a class="btn btn-sm bg-gradient-info btn-export-bill btn-sm d-inline-block align-middle ml-2 text-white" id="print-all" data-url="<?=$linkPrint?>" title="In tất cả" target="_blank" title="In tất cả"  ><i class="fas fa-print mr-2"></i>In tất cả</a>
            <?php } ?>
        </div>
