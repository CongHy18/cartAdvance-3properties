                ...
                <div class="row">
                    ...
                    <?php if (isset($config['setting']['tiktok']) && $config['setting']['tiktok'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <input type="text" class="form-control text-sm" name="data[options][tiktok]" id="tiktok" placeholder="Tiktok" value="<?= (!empty($flash->has('tiktok'))) ? $flash->get('tiktok') : @$options['tiktok'] ?>">
                        </div>
                    <?php } ?>
