                                        ...
                                        <?php if (!empty($v['dropdown'])) { ?>
                                            <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                                                ...
                                                <ul class="nav nav-treeview">
                                                    ...
                                                    <?php if (isset($v['version']) && $v['version'] == true) {
                                                        $none = "";
                                                        $active = "";
                                                        if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('product', 'man_version', $k, null, 'phrase-1')) $none = "d-none";
                                                        if ($com == 'product' && ($act == 'man_version' || $act == 'add_version' || $act == 'edit_version') && $k == $_GET['type']) $active = "active"; ?>
                                                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_version&type=<?= $k ?>" title="Danh mục phiên bản"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                                <p>Danh mục phiên bản</p>
                                                            </a></li>
                                                    <?php } ?>
