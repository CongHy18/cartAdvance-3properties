...
$linkSave = "index.php?com=product&act=save_version&type=" . $type;
?>
<!-- Content Header -->
    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Chi tiết phiên bản <?= $config['product'][$type]['title_main'] ?></li>
            </ol>
        </div>
    </div>
</section>
    ...
    <form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <div class="card card-primary card-outline text-sm">
            <div class="card-header">
                <h3 class="card-title"><?= ($act == "edit_version") ? "Cập nhật" : "Thêm mới"; ?> phiên bản <?= $config['product'][$type]['title_main'] ?></h3>
            </div>
            <div class="card-body">
