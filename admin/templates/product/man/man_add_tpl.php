                                ...
                                <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                    <?php foreach ($config['website']['lang'] as $k => $v) { ?>
                                        <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-lang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                                            ...
                                            <?php if (isset($config['product'][$type]['address']) && $config['product'][$type]['address'] == true) { ?>
                                                <div class="form-group">
                                            ...
                                            <?php if (isset($config['product'][$type]['link']) && $config['product'][$type]['link'] == true) { ?>
                                                <div class="form-group">
                                                    <label for="link">Link bản đồ:</label>
                                                    <input type="text" class="form-control text-sm" name="data[link]" id="link" placeholder="Link bản đồ" value="<?= (!empty($flash->has('link'))) ? $flash->get('link') : @$item['link'] ?>" required>
                                                </div>
                                            <?php } ?>
                                            ...
                                            <?php if (isset($config['product'][$type]['desc']) && $config['product'][$type]['desc'] == true) { ?>
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control for-seo text-sm <?= (isset($config['product'][$type]['desc_cke']) && $config['product'][$type]['desc_cke'] == true) ? 'form-control-ckeditor' : '' ?>" name="data[desc<?= $k ?>]" id="desc<?= $k ?>" rows="3" placeholder="Mô tả (<?= $k ?>)"><?= $func->decodeHtmlChars($flash->get('desc' . $k)) ?: $func->decodeHtmlChars(@$item['desc' . $k]) ?></textarea>
                                                </div>
                                            <?php } ?>

                                            <?php if (isset($config['product'][$type]['promotions']) && $config['product'][$type]['promotions'] == true) { ?>
                                                <div class="form-group">
                                                    <label for="promotions<?= $k ?>">Chương trình khuyến mãi (<?= $k ?>):</label>
                                                    <textarea class="form-control for-seo text-sm <?= (isset($config['product'][$type]['promotions_cke']) && $config['product'][$type]['promotions_cke'] == true) ? 'form-control-ckeditor' : '' ?>" name="data[promotions<?= $k ?>]" id="promotions<?= $k ?>" rows="3" placeholder="Chương trình khuyến mãi (<?= $k ?>)"><?= $func->decodeHtmlChars($flash->get('promotions' . $k)) ?: $func->decodeHtmlChars(@$item['promotions' . $k]) ?></textarea>
                                                </div>
                                            <?php } ?>
                                            ...
                                            <?php if (isset($config['product'][$type]['content']) && $config['product'][$type]['content'] == true) { ?>
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control for-seo text-sm <?= (isset($config['product'][$type]['content_cke']) && $config['product'][$type]['content_cke'] == true) ? 'form-control-ckeditor' : '' ?>" name="data[content<?= $k ?>]" id="content<?= $k ?>" rows="3" placeholder="Nội dung (<?= $k ?>)"><?= $func->decodeHtmlChars($flash->get('content' . $k)) ?: $func->decodeHtmlChars(@$item['content' . $k]) ?></textarea>
                                                </div>
                                            <?php } ?>
                                        </div>
                                    <?php } ?>
                    ...
                    <div class="card card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            <div class="form-group-category row">
                                ...
                                <?php if (isset($config['product'][$type]['version']) && $config['product'][$type]['version'] == true) { ?>
                                    <div class="form-group col-xl-6 col-sm-4">
                                        <label class="d-block" for="id_version">Danh mục phiên bản:</label>
                                        <?= $func->getVersion(@$item['id']) ?>
                                    </div>
                                <?php } ?>
