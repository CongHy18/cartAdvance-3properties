    ...
    <div class="row">
                ...
                <div class="category-box">
                    ...
                    <div class="section__category section__item__category mb-2 ">
                        <ul class="box_category_list">
                            <li>
                                <a href="<?= $productcatsingle[0]['slugvi'] ?>" class="d-flex justify-content-start align-items-center active transition"><i class="fa-light fa-angles-right"></i><?= $productcatsingle[0]['name' . $lang] ?> </a>
                                <ul>
        ...
        <div class="col-md-9">
            <?php foreach ($productitem as $klist => $vlist) {
                $items = $cache->get("select * from #_product where type = ? and id_item = ? and find_in_set('hienthi',status) $where2 order by numb,id desc $limit", array('san-pham', $vlist['id']), 'result', 7200);
            ?>
