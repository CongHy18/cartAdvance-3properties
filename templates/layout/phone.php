    ...
    <div id="gom-all-in-one">
        ...
        <div id="contact-vr" class="button-contact">
            <div class="phone-vr">
                ...
                <div class="phone-vr-img-circle">
                    <a target="_blank" rel="nofollow" href="<?= $optsetting['fanpage'] ?>">
                        <img width="50" height="50" src="assets/images/contact2.png" alt="mess" class="lazyloaded" data-ll-status="loaded"><noscript><img width="50" height="50" src="assets/images/contact2.png" alt="mess" /></noscript>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div id="zalo-vr" class="button-contact">
            <div class="phone-vr">
                <div class="phone-vr-circle-fill"></div>
                <div class="phone-vr-img-circle">
                    <a target="_blank" rel="nofollow" href="https://zalo.me/<?= $func->parsePhone($optsetting['zalo']) ?>">
                        <img width="100" height="95" src="assets/images/zalo.png" alt="zalo" class="lazyloaded" data-ll-status="loaded"><noscript><img width="100" height="95" src="assets/images/zalo.png" alt="zalo" /></noscript>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="phone-vr">
                ...
                <div class="phone-vr-img-circle">
                    <a href="tel:<?= $func->parsePhone($optsetting['hotline']) ?>">
                        <img width="50" height="50" src="assets/images/phone.png" alt="phone" class="lazyloaded" data-ll-status="loaded"><noscript><img width="50" height="50" src="assets/images/phone.png" alt="phone" /></noscript>
                    </a>
                </div>
            </div>
        </div>
        <div class="phone-bar phone-bar-n">
            <a href="tel:<?= $func->parsePhone($optsetting['hotline']) ?>">
                <span class="text-phone"><?= $func->parsePhone($optsetting['hotline']) ?></span>
            </a>
        </div>
